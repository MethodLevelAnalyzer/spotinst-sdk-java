...
class SpotinstElastigroupService extends BaseSpotinstService {
    ...
    public static ApiSuspendedProcesses removeSuspensions(String groupId, ApiRemoveSuspensionsRequest request,
        ...
        if (castedResponse.getResponse().getCount() > 0) {
            ...
            retVal = buildEmptySuspendedProcessesResponse(groupId);
        }
    ...
    public static ApiSuspendedProcesses getSuspendedProcesses(String elastigroupId, String authToken, String account) {
        ...
        if (castedResponse.getResponse().getCount() > 0) {
            ...
            retVal = buildEmptySuspendedProcessesResponse(elastigroupId);
        }
    ...
    private static ApiSuspendedProcesses buildEmptySuspendedProcessesResponse(String groupId) {
        ...
        retVal = new ApiSuspendedProcesses();
        retVal.setGroupId(groupId);
        retVal.setProcesses(new LinkedList<>());
        retVal.setSuspensions(new LinkedList<>());
