...
public class VolumeAutoResize {
    ...
    private List<VolumeAutoResizeResizePolicyAction> resizePolicies;
    //endregion
    ...
    public List<VolumeAutoResizeResizePolicyAction> getResizePolicies() {
        return resizePolicies;
    }

    public void setResizePolicies(List<VolumeAutoResizeResizePolicyAction> resizePolicies) {
    ...
    public static class Builder {
        ...
        protected Builder setMode(final String mode) {
        ...
        public Builder setResizePolicies(final List<VolumeAutoResizeResizePolicyAction> resizePolicies) {
