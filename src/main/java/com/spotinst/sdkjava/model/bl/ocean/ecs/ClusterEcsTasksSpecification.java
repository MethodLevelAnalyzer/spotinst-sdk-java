...
public class ClusterEcsTasksSpecification {
    @JsonIgnore
    ...
    public ClusterEcsTasksSpecification() { isSet = new HashSet<>(); }
    ...
    public static class Builder {
        private ClusterEcsTasksSpecification task;

        private Builder(){ this.task = new ClusterEcsTasksSpecification(); }
        ...
        public ClusterEcsTasksSpecification build(){
            return task;
        }
    }
