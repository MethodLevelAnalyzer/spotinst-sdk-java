...
public class VolumeSpecProtocolExportPolicyRule {
    ...
    public static class Builder {
        ...
        protected Builder setIndex(final Integer index) {
            volumeSpecProtocolExportPolicyRule.setIndex(index);
            return this;
        }

        //region Build methods
        protected Builder setAllowedClients(final String allowedClients) {
            volumeSpecProtocolExportPolicyRule.setAllowedClients(allowedClients);
            return this;
        }

        //region Build methods
        protected Builder setAccess(final String access) {
            volumeSpecProtocolExportPolicyRule.setAccess(access);
            return this;
        }

        //region Build methods
        protected Builder setRoot(final Boolean root) {
            volumeSpecProtocolExportPolicyRule.setRoot(root);
            return this;
        }

        //region Build methods
        protected Builder setKerberosRuleAccesses(final List<String> kerberosRuleAccesses) {
