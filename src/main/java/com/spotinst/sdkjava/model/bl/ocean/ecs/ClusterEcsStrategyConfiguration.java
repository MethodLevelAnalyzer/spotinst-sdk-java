...
public class ClusterEcsStrategyConfiguration {
    @JsonIgnore
    ...
    private ClusterEcsStrategyConfiguration() {
        isSet = new HashSet<>();
    }
    ...
    public static class Builder {
        ...
        private Builder() {
            this.strategy = new ClusterEcsStrategyConfiguration();
        }
        ...
        public ClusterEcsStrategyConfiguration build() {
            return strategy;
        }
    }
