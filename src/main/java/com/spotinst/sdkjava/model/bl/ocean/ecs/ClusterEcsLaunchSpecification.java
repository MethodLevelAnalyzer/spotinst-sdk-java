...
public class ClusterEcsLaunchSpecification {
    //region Members
    @JsonIgnore
    ...
    private ClusterEcsLaunchSpecification() {
        isSet = new HashSet<>();
    }
    //endregion
    ...
    public ClusterEcsIamInstanceProfileSpec getIamInstanceProfile() {
        return iamInstanceProfile;
    }

    public void setIamInstanceProfile(ClusterEcsIamInstanceProfileSpec iamInstanceProfile) {
    ...
    public static class Builder {
        ...
        private Builder() {
            this.launchSpecification = new ClusterEcsLaunchSpecification();
        }
        ...
        public Builder setIamInstanceProfile(final ClusterEcsIamInstanceProfileSpec iamInstanceProfile) {
        ...
        public ClusterEcsLaunchSpecification build() {
